...
var App = function () {
    ...
    //-----------------------------------------------------
    //start Ajax Load DNTCaptcha Content

    var loadDNTCaptchaContent = function (contentId) {

        if ($('#' + contentId).length > 0) {

            $.ajax({
                url: "/Home/DNTCaptchaContent",
                type: 'GET',
                dataType: "html",
                beforeSend: function () {
                    App.LoaderShow();
    ...
    //end Ajax Load DNTCaptcha Content
    //-----------------------------------------------------
    ...
    return {
        ...
        LoadDNTCaptchaContent: loadDNTCaptchaContent
